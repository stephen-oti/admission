  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1><b>Finance Tray in</b></h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Stage 2</a></li>
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
             ...
             <div class="col-md-2">
             <a href="printfinance.php" ><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#">
                  PRINT
                </button></a>
             </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                     $sql = "SELECT * FROM studentdetails WHERE stage<>1 and stage<>2";
                     $query = mysqli_query($conn,$sql);
                        if (mysqli_num_rows($query) > 0) {
                          while ($row = mysqli_fetch_array($query)) {
                            $no = $row['id'];
                          ...
                          echo "
                            ...
                            <td>$nid</td>
                            <td>Cleared</td>
                            <td><button type='button' id='rev-$no' name='rev' class='btn btn-secondary rev' data-toggle='modal'>Revert</button></td>
