        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
             ...
             <div class="col-md-2">
             <a href="printhostel.php" ><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#">
                  PRINT
                </button></a>
             </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                     $sql = "SELECT * FROM studentdetails WHERE stage<>1 and stage<>2 and stage<>3";
                     $query = mysqli_query($conn,$sql);
                        if (mysqli_num_rows($query) > 0) {
                          while ($row = mysqli_fetch_array($query)) {
                            $no = $row['id'];
                          ...
                          echo "
                            ...
                            <td>$nid</td>
                             ...
                             <button type='button' id='revone-$no' name='revone' class='btn btn-primary revone' data-toggle='modal'> Revert 1</button></center></td> 
                            </tr>
                          ";
