...
<div class="wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Regtistered Students</a></li>
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
             ...
             <div class="col-md-2">
             <a href="printreg.php" ><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#">
                  PRINT
                </button></a>
             </div>
                     ...
                     $query = mysqli_query($conn,$sql);
                        if (mysqli_num_rows($query) > 0) {
                          ...
                          echo "
                            ...
                            <td><img src='$picsource' alt='$picname' width=60></td>
                            </tr>
                          ";
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2014-2021 <a href="#">Maseno</a>.</strong> All rights
    reserved.
  </footer>
