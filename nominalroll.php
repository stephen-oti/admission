...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1><b>Nominal Roll Tray in</b></h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Stage 4</a></li>
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
             ...
             <div class="col-md-2">
             <a href="printnominal.php" ><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#">
                  PRINT
                </button></a>
             </div>
   ...
   <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1><b>Nominal Roll Tray out</b></h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Stage 4</a></li>
                     ...
                     $query = mysqli_query($conn,$sql);
                        if (mysqli_num_rows($query) > 0) {
                          ...
                          echo "
                            ...
                            <td>$nid</td>
                             <td>Cleared</td>
                             <td><center><button type='button' id='rev-$no' name='rev' class='btn btn-secondary rev' data-toggle='modal'>Revert</button> 
                             <button type='button' id='revone-$no' name='revone' class='btn btn-primary revone' data-toggle='modal'>Revert one</button> 
                             <button type='button' id='revtwo-$no' name='revtwo' class='btn btn-warning revtwo' data-toggle='modal'>Revert two</button></center></td> 
                            </tr>
                          ";
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2014-2021 <a href="Maseno.ac.ke">Maseno</a>.</strong> All rights
    reserved.
  </footer>
...
<script>
  ...
  $(document).ready(function(){
    $('.revone').click(function(){
      var id = $(this).attr('id').replace('revone-','');
      jQuery.ajax({
      url:"nominalrollaction.php",
      data: 'revone='+id,
      type: "POST",
  ...
  $(document).ready(function(){
    $('.revtwo').click(function(){
      var id = $(this).attr('id').replace('revtwo-','');
      jQuery.ajax({
      url:"nominalrollaction.php",
      data: 'revtwo='+id,
      type: "POST",
