        ...
        <div class="contact_detail">    
          <ul>
            <li>
              ...
              <div class="contact_info_m"><a href="#"><p>Muthaiga,Nairobi Kenya</p></a></div>
              
            </li>
            
            <li>
              <div class="icon_wrap"><i class="fa fa-envelope-o" aria-hidden="true"></i></div>
              <div class="contact_info_m"><a href="#"><p>desk@gardenuniversity.sc.ke</p></a></div>
                     
                
            </li>
            <li>
              <div class="icon_wrap"><i class="fa fa-phone" aria-hidden="true"></i></div>
              <div class="contact_info_m"><a href="#"><p>(+254)700000000</p></a></div>
            </li>
          </ul>
